...
#ifndef PUSHWOOSHKEYCHAIN_SWIFT_H
#define PUSHWOOSHKEYCHAIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PushwooshKeychain",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("PushwooshKeychainImplementation") SWIFT_AVAILABILITY(ios,introduced=12.0)
@interface PushwooshKeychainImplementation : NSObject <PWKeychain>
...
///
/// returns:
/// <code>nil</code> in App Store builds (module disabled)
