...
//
//  PWNotificationCategoryBuilderUserNotifications.m
//  Pushwoosh
//
...
@interface PWNotificationCategoryBuilderUserNotifications()
...
@implementation PWNotificationCategoryBuilderUserNotifications
...
- (void)setActionTitle:(NSString*)title {
    _actionTitle = [PWNotificationCategoryBuilderUserNotifications localizedString:title withDefault:title];
}
...
- (void)setActionTextInputWithTitle:(NSString*)title placeholder:(NSString*)placeholder {
    _actionTextInputTitle = [PWNotificationCategoryBuilderUserNotifications localizedString:title withDefault:@"Send"];
    _actionTextInputPlaceHolder = [PWNotificationCategoryBuilderUserNotifications localizedString:placeholder withDefault:@""];
}
