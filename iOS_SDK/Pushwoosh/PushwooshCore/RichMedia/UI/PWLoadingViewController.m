...
+ (instancetype)showLoading {
    ...
    PWLoadingViewController *viewController = [[self alloc] initWithWindow:presentedWindow richMediaStyle:[[PWManagerBridge shared] richMediaManager].richMediaStyle];
