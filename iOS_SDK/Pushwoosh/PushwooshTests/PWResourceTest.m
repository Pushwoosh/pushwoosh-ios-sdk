...
+ (NSDictionary *)dict {
    ...
    if (dictionary == nil) {
        dictionary =  [[NSDictionary alloc] initWithObjectsAndKeys: @"topbanner", @"layout", @1234567890, @"updated", @"1q2w3e4r5t6y7u8", @"hash", @"AAAAA-11111", @"code", @0, @"closeButtonType", @"https://fakeurl.com/11111-AAAAA", @"url", nil];
    }
    return dictionary;
}
